...
public class Mine_edu extends JavaPlugin{
	public static Mine_edu plugin;
	public final static Logger logger = Logger.getLogger("Minecraft");
	public final Commands mode = new Commands(this);
	...
	public void onDisable() {
		...
		Mine_edu.logger.info(pdfFile.getName() + " is now disabled.");
	}
	
	@Override
	public void onEnable() {
		PluginDescriptionFile pdfFile = this.getDescription();
		Mine_edu.logger.info(pdfFile.getName() + " Plugin " + " version " + pdfFile.getVersion() + " is enabled.");
